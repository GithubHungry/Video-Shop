...
class Product{
    ...
    public static function getProductsListByCategory($categoryId = false,$page = 1){
        ...
        $db = Db::getConnection();
        $products = array();
        $result = $db->query("SELECT id,name,price,is_new FROM product WHERE status ='1' AND category_id = '$categoryId' ORDER BY id LIMIT ".self::SHOW_BY_DEFAULT.' OFFSET '.$offset);//Добавить image
        ...
        while ($row = $result->fetch()){
            ...
            //$products[$i]['image'] = $row['image'];//Добавить image
     ...
     public static function getImage($id)
    {
        ...
        $path = '/VideoMag/upload/images/products/';
